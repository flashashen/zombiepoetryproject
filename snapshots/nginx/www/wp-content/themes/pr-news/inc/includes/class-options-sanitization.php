...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'prpin' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'prpin' ),
		'repeat-y'  => __( 'Repeat Vertically', 'prpin' ),
		'repeat'    => __( 'Repeat All', 'prpin' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'prpin' ),
		'top center'    => __( 'Top Center', 'prpin' ),
		'top right'     => __( 'Top Right', 'prpin' ),
		'center left'   => __( 'Middle Left', 'prpin' ),
		'center center' => __( 'Middle Center', 'prpin' ),
		'center right'  => __( 'Middle Right', 'prpin' ),
		'bottom left'   => __( 'Bottom Left', 'prpin' ),
		'bottom center' => __( 'Bottom Center', 'prpin' ),
		'bottom right'  => __( 'Bottom Right', 'prpin')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'prpin' ),
		'fixed'  => __( 'Fixed in Place', 'prpin')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'prpin' ),
		'italic'      => __( 'Italic', 'prpin' ),
		'bold'        => __( 'Bold', 'prpin' ),
		'bold italic' => __( 'Bold Italic', 'prpin' )
		);
